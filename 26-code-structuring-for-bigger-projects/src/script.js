...
// Import the Experience class (a blueprint for setting up the 3D scene, camera, renderer, etc.)
// The blueprint is defined inside the Experience file and imported here.
import Experience from './Experience/Experience.js'



// Create an instance of the Experience class,
// and pass in the <canvas> element from the HTML with the class "webgl".
